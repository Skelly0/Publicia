        ...
        try:
            ...
            if success:
                ...
                model_descriptions = [
                    ...
                    f"**DeepSeek-R1**: Uses the 0528 version. Similar to V3 0324 but with reasoning. Great at creative writing, roleplaying, more creative responses, and in-character immersion, but sometimes may make things up due to its creativity. Often factually inaccurate. With free version uses ({bot.config.get_top_k_for_model('deepseek/deepseek-r1-0528:free')}) search results, otherwise uses ({bot.config.get_top_k_for_model('deepseek/deepseek-r1-0528')}).", # Updated description slightly for clarity
