        ...
        try:
            ...
            if success:
                ...
                model_descriptions = [
                    ...
                    f"**GPT-5 Mini**: An OpenAI model that is very good for factual accuracy, and avoiding hallucinations. However, it has poor formatting. Uses ({bot.config.get_top_k_for_model('openai/gpt-5-mini')}) search results.",
