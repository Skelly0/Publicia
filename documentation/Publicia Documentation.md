...
- `/agentic_query`: Ask a question using tool-powered search (initial 5 chunks; tools can retrieve a custom number via `top_k` (default 5, up to the model's limit) and can view specific chunks)
