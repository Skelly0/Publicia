...
| `/agentic_query` | Ask a question using tool-powered search with progress updates (starts with 5 chunks; search tools list chunk references—use `view_chunks` to fetch text—default 5, max 20) |
